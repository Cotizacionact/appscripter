...
function Two() {
    return (
        <div className="flex flex-wrap md:h-[50vh] p-2 px-10">
            <div className="w-full md:w-1/2 p-2">
            ...
            <div className="relative w-full md:w-1/2 p-2 flex">
                <Image src="/WebAppWithNoRecurringCharges.png" className="absolute left-[25%] w-1/2" width={800} height={800} alt="Payment plan"/>
