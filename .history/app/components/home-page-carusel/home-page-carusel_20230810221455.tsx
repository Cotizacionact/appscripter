...
import SecImg from '/HomePage2.png';
import Tail from '/tailwindcss-logotype.svg';
import CodLogo from '/CoduxLogo.png';
import NextLogo from '/NextLogo.png';
import NodeLogo from "/NodeLogo.svg"
import MongoLogo from "/MongoDB_Logo.svg.png"
import AppScriptLogo from "/GoogleAppLogo.png"
...
export const HomePageCarusel = () => {
    ...
    return (
        <div className="relative">
            ...
            <button className="absolute right-0 top-[50%] flex w-10 rotate-90 justify-center bg-black p-0.5 text-white opacity-40 hover:opacity-70">
                <AiOutlineArrowUp />
            </button>
            <button className="absolute left-0 top-[50%] flex w-10 -rotate-90 justify-center bg-black p-0.5 text-white opacity-40 hover:opacity-70">
                <AiOutlineArrowUp />
            </button>
        </div>
    );
    ...
    return (
        <div className="flex h-[40vh] p-2 px-10">
            ...
            <div className="flex w-1/2 items-center justify-center p-2">
                <img src={Logo} className="w-2/3 rounded"/>
            </div>
        </div>
    );
}
    ...
    return (
        <div className="flex h-[40vh] p-2 px-10">
            ...
            <div className="relative w-1/2 p-2">
                <img src={SecImg} className="absolute left-[25%] h-full" />
                ...
                <div className="flex w-3/4 flex-col items-center rounded-xl border-2 bg-[#1d4ed8]  p-2 text-2xl text-white">
                    ...
                    {show === true && (
                        <div className="mt-2 flex w-full flex-col items-center space-y-2 rounded-lg bg-white p-2">
                            ...
                            <img src={CodLogo} className="w-1/2" />
                            <div className="w-full border-b border-black"></div>
                            <img src={NextLogo} className="w-2/5" />
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="flex w-3/4 flex-col items-center rounded-xl border-2 bg-[#1d4ed8]  p-2 text-2xl text-white">
                    ...
                    {show2 === true && (
                        <div className="mt-2 flex w-full flex-col items-center space-y-2 rounded-lg bg-white p-2">
                            ...
                            <img src={AppScriptLogo} className="w-2/3" />
                            <div className="w-full border-b border-black"></div>
                            <img src={MongoLogo} className="w-3/5" />
                        </div>
                    )}
                </div>
            </div>
