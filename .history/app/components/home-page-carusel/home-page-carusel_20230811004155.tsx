...
export const HomePageCarusel = () => {
    ...
    const [classManager, setClassManager] = React.useState({
        first:"w-3 h-1 bg-black/50 absolute left-[49%]",
        second:"w-3 h-1 bg-black/50 absolute left-[50%]",
        third:"w-3 h-1 bg-black/50 absolute left-[51%]"
    })
    ...
    return (
        <div className="relative">
            ...
            <div className={classManager.first}></div>
            <div className={classManager.second}></div>
            <div className={classManager.third}></div>
        </div>
    );
};
