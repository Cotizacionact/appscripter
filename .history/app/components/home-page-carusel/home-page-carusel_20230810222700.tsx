...
export const HomePageCarusel = () => {
    ...
    return (
        <div className="relative">
            ...
            <button className="absolute right-0 top-[50%] flex w-10 rotate-90 justify-center bg-black p-0.5 text-white opacity-40 hover:opacity-70" onClick={()=>{ console.log("here"); if(state >= max){;setState(state+1 as keyof Carusel)}else{setState(1)}}}>
                <AiOutlineArrowUp />
            </button>
