...
function Two() {
    return (
        <div className="flex flex-wrap  p-2 px-10">
            <div className="w-full md:w-1/2 p-2">
            ...
            <div className="w-full md:w-1/2 p-2 flex items-center min-h-[50vh] justify-center">
                <Image src="/WebAppWithNoRecurringCharges.png" className="w-full lg:w-1/2" width={800} height={800} alt="Payment plan"/>
...
function Three() {
    ...
    return (
        <div className="flex p-2 px-10 min-h-[50vh] flex-wrap">
